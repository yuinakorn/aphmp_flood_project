        ...
        <div className="relative flex h-full flex-col justify-between p-12">
          ...
          <div className="max-w-md">
            <p className="text-[11px] font-medium uppercase tracking-[0.12em] text-[var(--accent)]">
              Provincial Flood Operations
            </p>
            <h1 className="mt-3 text-[26px] font-semibold leading-tight tracking-tight">
              ติดตามน้ำท่วม
              <br />
              เห็นกลุ่มเปราะบางก่อนน้ำมา
            </h1>
            <p className="mt-4 max-w-sm text-[13px] leading-relaxed text-[var(--fg-muted)]">
              ระบบสำหรับเจ้าหน้าที่ ปภ. และ อบต.
              เพื่อบัญชาการอพยพในเหตุการณ์น้ำหลาก
              ด้วยข้อมูล Sentinel SAR และทะเบียนผู้ป่วยเปราะบาง
            </p>
          </div>
        ...
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={onSubmit} className="mt-6 flex flex-col gap-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-1 inline-flex h-9 items-center justify-center gap-2 rounded-md bg-[var(--accent)] px-4 text-[13px] font-medium text-[var(--accent-fg)] transition-opacity hover:opacity-90 disabled:opacity-60"
            >
